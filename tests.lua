...
local function test(bits)
  ...
  do -- number conversion
    local function test_num2num(x)
      ...
      assert_eq(bint.convert(x):tointeger(), x)
      assert_eq(bint.fromuinteger(x):tointeger(), x)
      assert_eq(bint.new(bint(x)):tointeger(), x)
      assert_eq(bint.convert(bint(x)):tointeger(), x)
      assert_eq(bint.new(tostring(x)):tointeger(), x)
      assert_eq(bint.convert(tostring(x)):tointeger(), x)
    ...
    assert_eq(bint.fromnumber(nil), nil)
    assert_eq(bint.fromnumber(1.5):tointeger(), 1)
    assert_eq(bint.fromnumber(-1.5):tointeger(), -1)
    ...
    assert_eq(bint.convert(nil), nil)
    assert_eq(bint.convert(1), bint(1))
    assert_eq(bint.convert(1.5), nil)
